...
export default function ColdDrinksComp() {
  ...
  const coldDrinksSwiperRef = useRef(null);
  ...
  useEffect(() => {
    ...
    if (coldDrinksSwiperRef.current) {
      coldDrinksSwiperRef.current.destroy(true, true);
    }

    coldDrinksSwiperRef.current = new Swiper(".coldDrinks-swiper", {
      modules: [Autoplay],
      speed: 2500,
      spaceBetween: 30,
      slidesPerView: 2.5,
  ...
  return (
    <>
      <div className="prodSection row justify-content-start align-items-center gap-2 p-2 m-1">
        ...
        <div className="swiper coldDrinks-swiper">
